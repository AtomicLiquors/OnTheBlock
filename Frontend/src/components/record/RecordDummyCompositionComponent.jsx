          ...
          <S.Grid>
            ...
            <S.TopLeft>
              {sessionsMap.has("TOP_LEFT") && (
                ...
                >
                  <Video
                    src={"https://www.pexels.com/ko-kr/download/video/4088185/"}
            ...
            <S.BottomLeft>
              {sessionsMap.has("BOTTOM_LEFT") && (
                ...
                >
                  <Video
                    src={"https://www.pexels.com/ko-kr/download/video/4088846/"}
...
export default RecordDummyCompositionComponent;
